...
frame.pack()
text = tk.Text(frame, wrap=tk.WORD, bg='black', fg='white', font=('Arial', 12))  # Set text background and font color
text.pack()
hp_label = tk.Label(root, text="HP: 100", bg='black', fg='white', font=('Arial', 12))  # Set HP label background and font color
hp_label.pack()
